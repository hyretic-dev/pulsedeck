...
-- MIGRATION: Add columns for events
DO $$
BEGIN
    ...
    END IF;
    -- We cannot reference working_groups yet because it is not created!
END $$;
...
-- MIGRATION: Add columns for events referencing working_groups
DO $$
BEGIN
