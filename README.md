...
3.  **Environment konfigurieren:**
    Das Projekt bringt bereits die passenden Default-Zugangsdaten für die lokale Supabase-Entwicklung mit. Mit diesem Befehl wird die Konfiguration automatisch eingerichtet:
    ```bash
    npm run setup:env
    ```
